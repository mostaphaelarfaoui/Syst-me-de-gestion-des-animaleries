...
<body>
    ...
    <div class="animo">
        <form action="" method="post">
            ...
            <p><input type="text" placeholder="Enter weight" name="weight" style="width: 49%;"> <input type="text"
                    placeholder="Enter height" name=" height" style="width: 49%;"></p>
            <p><input type="text" placeholder="Enter age" name="age" style="width: 49%;"> <input type="text"
                    placeholder="Enter fur" name="fur" style="width: 49%;"></p>
